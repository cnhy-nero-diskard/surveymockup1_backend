...
import { calculateAverageCompletionTimeService, fetchByCountryResidence, fetchByGender, fetchAllFinishedRows, fetchAndGroupFinishedSurveyResponsesByMonthService, fetchByNationality, fetchByTimeOfDay, fetchTouchpointsService, fetchUnfinishedSurveys, fetchEntityinSurveyFeedbackService, getAllSurveyTally } from '../services/analyticsCRUD.js';
...
router.get('/api/test', async (req, res) => {
    try {
        ...
        const result = await getAllSurveyTally() ;
        res.json(result);
    } catch (error) {
